                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <ul class="breadcrumb-nav">
                            @yield('breadcrumb')
                            <li><a href="{{ route('home') }}"><i class="lni lni-home"> home</i></a></li>
                            <li><a href="{{ route('product.index') }}"><i class="lni lni-home"> shop</i></a></li>
                            <li>{{ $product->name }}</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <!-- If you have multiple images, loop here. Otherwise, just show the main image. -->
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <form action="{{ route('cart.store') }}" method="post">
                                ...
                                <div class="row">
                                    <!-- Example options, you can make these dynamic if you have options -->
