                                ...
                                <li>
                                    <div class="select-position">
                                        <form action="{{ route('currency.store') }}" method="post">
                                            @csrf
                                            {{-- <select id="select4"name="currency_code">
                                                ...
                                                <option value="LIS"@selected('LIS' == session('currency_code'))>$ LIS</option>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            ...
                                            <li class="nav-item"><a href="product-details.html">shop Single</a>
                                            </li>
